...
<div class="corollary">
Let $S \subset M$ be a smooth immersion of the closed disk in $M$. Given $x \in \partial S$ and $e_x \in E_x$, let $P_{\partial S}e_x \in E_x$ be the parallel transation of $e_x$ around $\partial S$. If $E_x$ has an inner product, then
  \[
